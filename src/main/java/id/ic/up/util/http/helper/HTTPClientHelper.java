package id.ic.up.util.http.helper;

import java.util.List;
import java.util.stream.Collectors;

import id.ic.up.util.http.model.HTTPHeader;
import id.ic.up.util.http.model.HTTPParameter;
import id.ic.up.util.http.model.HTTPRequest;
